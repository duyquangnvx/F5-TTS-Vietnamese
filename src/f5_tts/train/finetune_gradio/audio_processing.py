"""
Audio processing utilities for F5-TTS fine-tuning.

This module contains the Slicer class and related audio processing functions
...
def get_rms(
    ...
    Based on: https://github.com/RVC-Boss/GPT-SoVITS/blob/main/tools/slicer2.py
    """
...
class Slicer:
    """
    Audio slicer for splitting audio into segments based on silence detection.
